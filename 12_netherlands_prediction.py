...
"""
Netherlands GP 2026 - Winner Prediction Model
===========================================
...
for session_name in ["FP1", "SQ" ,"S", "Q"]:
    session = fastf1.get_session(2026, "Netherlands", session_name)
    session.load()
...
"QualifyingTime (s)": [ 73.182,     #ALB
                        ...
                        73.574,     #SAI
                        73.818,     #STR
                        72.627,     #TSU                # had to delete hadjar until he returns from his injury
                        71.618]     #VER
})
...
API_KEY = ""
City = "Zandvoort"
date_of_race = "2026-08-23"                     # must follow YYYY-MM-DD
...
🥈 P2: RUS
🥉 P3: ANT
Model Absolute Error (MAE) : 0.15 seconds
"""
