...
"""
Spain GP 2026 - Winner Prediction Model
===========================================
...
for session_name in ["FP1","FP2", "FP3", "Q"]:
    session = fastf1.get_session(2026, "Spain", session_name)
    session.load()
...
API_KEY = ""
City = "Madrid"
date_of_race = "2026-09-13"                     # must follow YYYY-MM-DD
