...
"""
Britain GP 2026 - Winner Prediction Model
===========================================
...
for session_name in ["FP1", "SQ" ,"S", "Q"]:
    session = fastf1.get_session(2026, "Britain", session_name)
    session.load()
...
date_of_race = "2026-07-05"                     # must follow YYYY-MM-DD
