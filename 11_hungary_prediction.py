...
"""
Hungary GP 2026 - Winner Prediction Model
===========================================
...
for session_name in ["FP1","FP2", "FP3", "Q"]:
    session = fastf1.get_session(2026, "Hungary", session_name)
    session.load()
...
API_KEY = ""
City = "Budapest"
date_of_race = "2026-07-26"                     # must follow YYYY-MM-DD
