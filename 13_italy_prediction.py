...
"""
Italy GP 2026 - Winner Prediction Model
===========================================
...
for session_name in ["FP1","FP2", "FP3", "Q"]:
    session = fastf1.get_session(2026, "Italy", session_name)
    session.load()
...
API_KEY = ""
City = "Monza"
date_of_race = "2026-09-06"                     # must follow YYYY-MM-DD
